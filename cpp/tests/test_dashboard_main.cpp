/**
 * AlgoForge — tests/test_dashboard_main.cpp
 * Standalone runner for Phase 5 dashboard parity tests (slice 1).
 */
...
void test_dashboard(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(72,'=').c_str());
    printf("  AlgoForge Dashboard Parity Tests (Phase 5, slice 1)\n");
    printf("  %s\n", std::string(72,'=').c_str());
    test_dashboard(run_test);
