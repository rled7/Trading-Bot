/**
 * AlgoForge — tests/test_alpaca_broker_main.cpp
 * Standalone runner for the Alpaca broker adapter tests (Phase 1 / S5).
 */
...
void test_alpaca_broker(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(80,'=').c_str());
    printf("  AlgoForge Alpaca Broker Adapter Tests (Phase 1 / S5)\n");
    printf("  %s\n", std::string(80,'=').c_str());

    test_alpaca_broker(run_test);
