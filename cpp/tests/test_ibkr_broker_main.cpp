/**
 * AlgoForge — tests/test_ibkr_broker_main.cpp
 * Standalone runner for the IBKR broker adapter tests (Phase 1 / S5).
 * Mirrors the test_rest_broker_main.cpp pattern.
 */
...
void test_ibkr_broker(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(80,'=').c_str());
    printf("  AlgoForge IBKR Broker Adapter Tests (Phase 1 / S5)\n");
    printf("  %s\n", std::string(80,'=').c_str());

    test_ibkr_broker(run_test);
