/**
 * AlgoForge — tests/test_s6_main.cpp
 * Standalone runner for the S6 discovery-daemon oracle (Phase 4).
 */
...
void test_s6(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(72,'=').c_str());
    printf("  AlgoForge S6 Discovery-Daemon Oracle (Phase 4)\n");
    printf("  %s\n", std::string(72,'=').c_str());
    test_s6(run_test);
