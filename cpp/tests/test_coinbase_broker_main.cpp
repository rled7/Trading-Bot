/**
 * AlgoForge — tests/test_coinbase_broker_main.cpp
 * Standalone runner for the Coinbase broker adapter tests (Phase 1 / S5).
 */
...
void test_coinbase_broker(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(80,'=').c_str());
    printf("  AlgoForge Coinbase Broker Adapter Tests (Phase 1 / S5)\n");
    printf("  %s\n", std::string(80,'=').c_str());
    test_coinbase_broker(run_test);
