/**
 * AlgoForge — tests/test_prompts_main.cpp
 * Standalone runner for algo_gen prompts tests (Phase 2).
 */
...
void test_prompts(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(72,'=').c_str());
    printf("  AlgoForge algo_gen Prompts Tests (Phase 2)\n");
    printf("  %s\n", std::string(72,'=').c_str());
    test_prompts(run_test);
