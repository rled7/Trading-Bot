/**
 * AlgoForge — tests/test_binance_broker_main.cpp
 * Standalone runner for the Binance broker adapter tests (Phase 1 / S5).
 */
...
void test_binance_broker(RawTestFn&);

int main() {
    printf("\n  %s\n", std::string(80,'=').c_str());
    printf("  AlgoForge Binance Broker Adapter Tests (Phase 1 / S5)\n");
    printf("  %s\n", std::string(80,'=').c_str());
    test_binance_broker(run_test);
