/**
 * prompts.js — Prompt template string constants.
 * Byte-identical to python/algoforge/llm/prompts.py.
 * All Unicode escapes match the Python source exactly.
 */

export const TRADE_RATIONALE_SYSTEM =
...
export const TRADE_RATIONALE_USER =
    'SIGNAL\n' +
    'symbol={symbol}\n' +
    'side={side}\n' +
    'timeframe={timeframe}\n' +
...
export const BACKTEST_COMMENTARY_SYSTEM =
...
export const BACKTEST_COMMENTARY_USER =
    'BACKTEST\n' +
...
export const NEWS_SENTIMENT_SYSTEM =
...
export const NEWS_SENTIMENT_USER =
    'HEADLINE: {headline}\n' +
    'BODY: {body_or_empty}';

export const STRATEGY_DESCRIBE_SYSTEM =
...
export const STRATEGY_DESCRIBE_USER =
    'STRATEGY\n' +
    'name={name}\n' +
    'timeframe={timeframe}\n' +
